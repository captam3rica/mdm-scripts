...
# Jamf Pro Extension Attribute to check if TouchID is enabled at the system
# level.
...
# Comment out the if then statements and change the TouchIDStatus= to results=
# for a 0 or 1 response
